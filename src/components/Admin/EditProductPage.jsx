                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    {[
                      ...
                      const isSelected = productData.colors.includes(color.name);
                      return (
                        <button
                          key={color.name}
                          type="button"
                  ...
                  {productData.colors.length > 0 && (
                    <div className="flex flex-wrap gap-1.5 mt-1">
                      ...
                      {productData.colors.map((c) => (
                        <span key={c} className="text-xs font-medium text-indigo-600">{c}</span>
                      ))}
                    </div>
                  )}
                  {/* Add Custom Color */}
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          if (name && !productData.colors.includes(name)) {
                            setProductData(prev => ({
                              ...prev,
