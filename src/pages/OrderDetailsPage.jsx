...
const OrderDetailsPage = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
            <div className="mb-8">
                <p className="text-xs tracking-[0.3em] uppercase text-lv-gold mb-2">Order</p>
                <h1 className="font-serif text-2xl sm:text-3xl text-lv-dark tracking-wide">Order Details</h1>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-3">
                    <Link to="/my-orders" className="text-lv-gold hover:underline inline-block">
                        &larr; Back to Orders
                    </Link>
                    {/* New Invoice Button */}
                    <button 
                        onClick={handleViewInvoice}
                        className="bg-lv-dark hover:bg-lv-dark/90 text-white py-2 px-4 flex items-center gap-2 self-start"
                    >
