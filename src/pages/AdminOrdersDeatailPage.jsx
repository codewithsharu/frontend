                    ...
                    <div class="mb-8">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ${orderItems.map((item) => {
                                    const sizeLabel = getDisplaySize(item.size);
                                    const customMeasurementSummary = getCustomMeasurementSummary(item);
                                    const variantParts = [];

                                    if (sizeLabel) {
                                        variantParts.push(`Size: ${sizeLabel}`);
                                    }
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="ml-0 sm:ml-4">
                                                    ...
                                                    ` : ''}
                                                    ${customMeasurementSummary.length > 0 ? `
                                                        <div class="mt-1 text-xs text-indigo-600">
                                                            Custom: ${customMeasurementSummary.join(' | ')}
                                                        </div>
                                                    ` : ''}
                                                </div>
                                            </div>
                        ...
                        <div class="w-full sm:w-72">
                            <div class="border-t border-gray-200 pt-4 space-y-2">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-gray-900">₹${orderItems.reduce((acc, item) => acc + (Number(item.price || 0) * Number(item.quantity || 0)), 0).toFixed(2)}</span>
                                </div>
        ...
        <div className="min-h-screen bg-gray-50 py-8">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center mb-6">
                    <Link to="/admin/orders" className="flex items-center text-indigo-600 hover:text-indigo-600/80 transition-colors mr-4">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white shadow-sm p-6">
                            ...
                            <div className="space-y-3">
                                <button 
                                    className="w-full bg-indigo-600 text-white py-2 px-4 hover:bg-indigo-600/90 transition-colors flex items-center justify-center"
                                ...
                                <button 
                                    className="w-full bg-white text-gray-900 border border-indigo-600 py-2 px-4 hover:bg-indigo-50 transition-colors flex items-center justify-center"
